...
var { mostrarNegocio, buscarNegocioID, nuevoNegocio, modificarNegocio, borrarNegocio, mostrarNegociosUsuario, incrementarCalificacion, mostrarUsuariosCalificados, mostrarNegocioOrdenadoPorCalificacion, validarCamposNoVacios}=require("../db/negocioBD");
...
ruta.post("/nuevonegocio", subirArchivo(), async(req,res)=>{
...
ruta.post("/editarnegocio", subirArchivo(), async(req,res)=>{
   if(req.file!=null){
...
ruta.post("/editarnegocioadmin", subirArchivo(), async(req,res)=>{
  if(req.file!=null){
    req.body.foto=req.file.filename;
    }else{
    req.body.foto=req.body.fotoAnterior;
...
ruta.post("/nuevosnegocios/:id", subirArchivo(), async(req,res)=>{
...
ruta.post("/modificarnegocio", subirArchivo(), async(req,res)=>{
  if(req.file!=null){
    req.body.foto=req.file.filename;
    }else{
    req.body.foto=req.body.fotoAnterior;
